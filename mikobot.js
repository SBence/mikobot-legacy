...
bot.on('message', async message => {
    ...
    if (guildEntry) {
        ...
        try {
            ...
            message.reply('A database error occurred while trying to run your command.');
            if (e.name === 'SequelizeUniqueConstraintError') {
                return console.log(`A guild entry with a matching ID (${message.guild.id}) already exists in the database.
                This error usually indicates a bug in the bot code, not in Sequelize.`);
            }
